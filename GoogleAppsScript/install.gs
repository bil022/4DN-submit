/*
 First step: run setup() to add private key to UserProperties, replace the xs:ys with key pair.
 */
function setup() {
  ...
  // Debugging: print out properties
...
/*
 onOpen will be called when the document is opened
 */
function onOpen() {
...
/*
 Assuming second row is the header
 */
...
/*
 do Get/Post/Patch to php server, display results
 */
...
/*
 Update accession number (col:2) using aliases (col:3)
 accession number should be empty when aliases should not
 */
...
/*
 Popup to ask if "Continue?" when error
 */
...
/*
 invoked by menu select test server
 */
...
/*
 invoked by menu select encode server
 */
...
/*
 invoked by menu get current server
 */
